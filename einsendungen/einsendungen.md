...
Der Quellcode ist das eigentliche Programm. Unbedingt darauf achten, dass der Quellcode gut dokumentiert ist. Sinnvolle Variablennamen verwenden. Gegebenenfalls den Funktionen einen docstring verpassen.
...
Der Quellcode sollte nach der Umwandlung in PDF noch lesbar sein, d.h. es sollten keine Zeilenumbrüche entstehen, die den Code unleserlich machen.
...
Auf der bwinf-Seite gibt es Vorlagen für die Dokumentation [hier](https://bwinf.de/bundeswettbewerb/teilnehmen/vorlagen/) <br>
Die OpenDocument-Format (odt) kann auch mit Word geöffnet und bearbeitet werden.

Eine weitere Möglichkeit ist die Erstellung der Dokumentation mit JupyterLab. Dazu gibt es
[eine Anleitung hier](einsendungen_mit_jupyterlab.md).
